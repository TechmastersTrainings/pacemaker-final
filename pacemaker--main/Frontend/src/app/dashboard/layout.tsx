...
import { 
  ...
  BookOpen, Trophy, Clock, MonitorPlay, Activity
} from 'lucide-react';
...
export default function StudentDashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const menuItems = [
    ...
    { icon: Activity, label: 'Patient Simulation', href: '/dashboard/patient-simulation' },
  ...
  return (
    <div className="flex min-h-[calc(100vh-4rem)] overflow-hidden">
      ...
      {/* Main Content Area */}
      <main className="flex-1 overflow-y-auto bg-[#fdfbf7] p-8 lg:p-12 custom-scrollbar relative">
         {children}
